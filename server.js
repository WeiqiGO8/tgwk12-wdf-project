...
// CREATE AND INITIATE USER TABLE
// Code generated by ChatGPT - BEGIN ------------------------------
// (ChatGPT, 2024,"is there a way to combine these without losing admin and regular users?", https://chatgpt.com/share/67003307-d090-800d-b3e7-7d0f014ff1a9)
// (ChatGPT, 2024, "I need to create a admin when the table starts, Have I not done that already=", https://chatgpt.com/share/6700352d-64e4-800d-a0f3-5fe554b80e7d)
		...
		async (error, user) => {
			if (error) {
				...
				if (isMatch) {
					...
					req.session.isLoggedIn = true; // Check if the user is logged in
...
// Source: (W3Schools, 2024, "Responsive Image Gallery", https://www.w3schools.com/css/tryit.asp?filename=trycss3_flexbox_image_gallery)
// Code borrowed from a website - END ------------------------------

// Code generated by ChatGPT - BEGIN ------------------------------
// (ChatGPT, 2024, "how to make the images align close next to each other without distorting the image, even though they are not the same size", https://chatgpt.com/share/66fcd7cc-9f04-800d-8d52-397ee038e178)
// Code generated by ChatGPT - END ------------------------------
